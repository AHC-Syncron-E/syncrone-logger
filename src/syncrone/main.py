...
class VentilatorApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        if getattr(sys, 'frozen', False):
            # Nuitka/Frozen: Assets are at the executable root
            BASE_DIR = Path(sys.executable).parent
            ASSET_DIR = BASE_DIR / "assets"
        else:
            # Dev Mode: Go up 3 levels (src/syncrone/main.py -> src/syncrone/ -> src/ -> root/)
        ...
        # Logo
        logo_path = None
        svg_file = ASSET_DIR / "ahc_logo.svg"
        png_file = ASSET_DIR / "ahclogo_transp_notxt_square.png"
